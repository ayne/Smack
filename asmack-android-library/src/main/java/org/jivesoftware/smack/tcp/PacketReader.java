            ...
            do {
                if (eventType == XmlPullParser.START_TAG) {
                    ...
                    // the connectionID lock so that the packet reader startup can finish.
                        ...
                        String yaptoken = parser.getAttributeValue(null, "x-yap-token");
                        String tts = parser.getAttributeValue(null, "c-tts");
                        connection.processPacket(new Success(yaptoken, tts, parser.nextText()));


                        /**
                         * Removed for TLS and fast recon optimization in Babble
